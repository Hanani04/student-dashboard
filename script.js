...
function startExamCountdown() {
    ...
    const timerInterval = setInterval(function() {
        ...
        if (distance < 0) {
            clearInterval(timerInterval);
            document.getElementById("exam-countdown").innerHTML = "PEPERIKSAAN SEDANG BERLANGSUNG!";
            return;
        }
...
// LOGIK TUKAR IKON BULAN / MATAHARI DI SINI
function toggleTheme() {
    ...
    if (currentTheme === "dark") {
        ...
        if (themeBtn) themeBtn.innerHTML = "🌙"; // Tukar kepada bulan jika mod cerah
    } else {
        document.documentElement.setAttribute("data-theme", "dark");
        localStorage.setItem("theme", "dark");
        if (themeBtn) themeBtn.innerHTML = "☀️"; // Tukar kepada matahari jika mod gelap
    }
}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Semak tema sedia ada dalam storan browser
